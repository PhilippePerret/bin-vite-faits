...
# Pour la class VFCommand qui permet de gérer la ligne de commande
VF_COMMAND = './vite-faits.rb'
...
=end
  ...
  CMD = File.join(Dir.home,'Movies','Tutoriels','SCRIVENER','LES_VITE_FAITS','bin','vite-faits.rb')
  def run command
    `#{CMD} #{command}`
  end
end
